    ...
    if (msg.isSysEx())
    {
        ...
        if (size > 14 && data[1] == 0x41 && data[6] == 0x44 && data[7] == 0x12)
        {
            if (data[8] == 0x05 && data[9] == 0x00)
            {
                ...
                if (baseAddress == 0x00) payloadOffset = 0;       
                else if (baseAddress == 0x40) payloadOffset = 32; 
                else if (baseAddress == 0x80) payloadOffset = 64; 
                else if (baseAddress == 0xC0) payloadOffset = 96; 
                else return;
...
print("Regenerated cleanly without race condition and without logger!")
