...
print("Running step78 to restore base state...")
with open('scratch/step78.py', 'r') as f:
    exec(f.read())

print("Applying fix for OSC3_FINE bounds...")
...
print("Applying fix for Data Race...")
...
print("Removing MIDI enumeration from PluginEditor.cpp...")
...
# Remove the lambda change handlers completely
...
print("Done resetting and applying fixes.")
