...
# The initialization block to move
init_block = """    ccParams.clear();
...
content = content.replace(init_block, "    ccParams.clear(); // Cleared on play, but populated in constructor")

# Add to constructor
constructor_sig = "SE02_ControllerAudioProcessor::SE02_ControllerAudioProcessor()\n#ifndef JucePlugin_PreferredChannelConfigurations\n     : AudioProcessor (BusesProperties()\n                     #if ! JucePlugin_IsMidiEffect\n                      #if ! JucePlugin_IsSynth\n                       .withInput  (\"Input\",  juce::AudioChannelSet::stereo(), true)\n                      #endif\n                       .withOutput (\"Output\", juce::AudioChannelSet::stereo(), true)\n                     #endif\n                       ),\n        apvts(*this, nullptr, \"Parameters\", createParameterLayout())\n#endif\n{"
new_constructor = constructor_sig + "\n" + init_block

if constructor_sig in content:
    content = content.replace(constructor_sig, new_constructor)
else:
    print("Could not find constructor signature!")
